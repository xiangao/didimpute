...
An R port of Georgii Marinichev’s Python
[`did_imputation`](https://github.com/Gmarinichev/did_imputation)
package, implementing the imputation estimator of Borusyak, Jaravel and
Spiess (2024, *Review of Economic Studies*) for staggered
difference-in-differences designs. (A separate, independent R
implementation is also available as
[`didimputation`](https://github.com/kylebutts/didimputation) by Kyle
Butts.)
...
The example below constructs a minimal synthetic staggered panel and
estimates event-study effects at horizons 0, 1, and 2, with two
